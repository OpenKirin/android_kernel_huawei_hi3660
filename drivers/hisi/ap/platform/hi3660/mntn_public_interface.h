...
typedef enum
{
    ...
    LPM3_S_EXCEPTION = 0x5a,
    SOCHIFI_S_EXCEPTION = 0x5b,
    HIFI_S_RESETFAIL = 0x5c,
    ISP_S_EXCEPTION = 0x5d,
    IVP_S_EXCEPTION = 0x5e,
    IOM3_S_EXCEPTION = 0x5f,
    TEE_S_EXCEPTION = 0x60,
    MMC_S_EXCEPTION = 0x61,
    CODECHIFI_S_EXCEPTION = 0x62,
    IOM3_S_USER_EXCEPTION = 0x63,
    HISEE_S_EXCEPTION = 0x64,
